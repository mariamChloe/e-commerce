      ...
      <q-toolbar>
        ...
        <div class="q-gutter-sm row items-center no-wrap">
          ...
          <q-btn round dense flat color="white" icon="fab fa-github" type="a"
                 href="https://github.com/mariamChloe" target="_blank">
          </q-btn>
          <q-btn round dense flat style="color:red !important;" type="a" href="https://github.com/mariamChloe"
                 target="_blank">
